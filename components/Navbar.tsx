...
export default function Navbar() {
    ...
    return (
        <Disclosure as="nav" className="bg-black sticky top-0 z-20">
            {({ open }) => (
                <>
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            <Link href="/" className="flex flex-row justify-center items-center gap-2 hover:animate-pulse transition duration-100">
                                ...
                                <span className="hidden sm:block uppercase tracking-[2px] text-sm text-white whitespace-nowrap">Vishwesh<br />Malur Somashekar</span>
                            </Link>
                            ...
                            <div className="flex flex-row justify-end items-center">
                                <a href="https://www.linkedin.com/in/vishweshms/" target="_blank" rel="noreferrer">
                                ...
                                <a href="https://github.com/VishweshMS" target="_blank" rel="noreferrer">
                                ...
                                <a href="mailto:msvishwesh99@gmail.com">
